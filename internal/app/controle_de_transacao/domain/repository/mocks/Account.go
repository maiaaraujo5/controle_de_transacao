...
// Find provides a mock function with given fields: parentContext, accountID
func (_m *Account) Find(parentContext context.Context, accountID string) (*model.Account, error) {
